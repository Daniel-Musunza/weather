...
const ImageView = () => {
  return (
        <div className="flex flex-col md1:flex-row w-[100%]">
            ...
            />
            <div className="rounded-b-[30px] md1:rounded-bl-[0px]  md1:rounded-e-[30px] h-[250px] bg-darkBlue-2 flex flex-col justify-center items-center md1:justify-start gap-[40px] px-[20px] pl-[20px] md1:pl-[40px] py-[40px] md1:pr-[180px] w-[100%] ">
