        ...
        <div className="flex flex-col gap-[40px] w-[100%]">
            ...
            >
                <div className="flex flex-row justify-center items-center">
                    <h1 className=' text-white text-[25px] font-[600]'>Find your dream holiday in Mauritius</h1>
                </div>
                <div className="flex flex-col  gap-4">
                    ...
                    <div className="flex flex-row items-center justify-center gap-[1px]">
                        <div className="flex flex-col gap-1 w-[100%]">
                            <label htmlFor="" className='text-white font-[600] '>Depature from</label>
                            <input type="date" name="" id=""
                                className="w-full pl-3 py-2 border border-darkBlue focus:outline-none rounded"
                            />
                        </div>
                        <div className="flex flex-col gap-1 w-[100%]">
                            <label htmlFor="" className='text-white font-[600] '>Back to</label>
                            <input type="date" name="" id=""
                                className="w-full pl-3 py-2 border border-darkBlue focus:outline-none rounded"
                            />
                        </div>
